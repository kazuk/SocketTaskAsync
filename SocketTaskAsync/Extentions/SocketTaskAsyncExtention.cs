...
namespace SocketTaskAsync.Extentions
{
    ...
    public static class SocketTaskAsyncExtention
    {
        ...
        /// <summary>
        /// Socket.Connect(string host,int port) を Task Asyncで実行します
        /// </summary>
        /// <param name="socket"></param>
        ...
        /// <summary>
        /// Socket.Connect( IPAddress[], port ) をTask Async 実行します。
        /// </summary>
        /// <param name="socket"></param>
        ...
        /// <summary>
        /// Socket.Connect( IPAddress address, int port )をTask Asyncします
        /// </summary>
        /// <param name="socket"></param>
